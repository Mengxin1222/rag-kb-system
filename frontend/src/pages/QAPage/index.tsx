...
const mockKBs: KnowledgeBase[] = [
  { id: 1, name: '产品手册知识库', description: '', docCount: 8, chunkCount: 142, created_at: '', chunk_method: 'heading', chunk_heading_levels: '2', chunk_max_chars: 1000, chunk_overlap: 0, retrieval_top_k: 20, bm25_top_k: 20, rrf_k: 60, rerank_top_n: 5, conversation_max_rounds: 10, context_compression: true, system_prompt: '', llm_model: 'deepseek-chat', llm_temperature: 0.7, embedding_model: '', rerank_model: '' },
  { id: 2, name: '技术文档知识库', description: '', docCount: 15, chunkCount: 230, created_at: '', chunk_method: 'heading', chunk_heading_levels: '2', chunk_max_chars: 1200, chunk_overlap: 100, retrieval_top_k: 25, bm25_top_k: 25, rrf_k: 60, rerank_top_n: 5, conversation_max_rounds: 15, context_compression: true, system_prompt: '', llm_model: 'deepseek-chat', llm_temperature: 0.5, embedding_model: '', rerank_model: '' },
  { id: 3, name: '规章制度知识库', description: '', docCount: 6, chunkCount: 89, created_at: '', chunk_method: 'heading', chunk_heading_levels: '3', chunk_max_chars: 800, chunk_overlap: 0, retrieval_top_k: 20, bm25_top_k: 20, rrf_k: 60, rerank_top_n: 5, conversation_max_rounds: 10, context_compression: true, system_prompt: '', llm_model: 'deepseek-chat', llm_temperature: 0.7, embedding_model: '', rerank_model: '' },
];
